  ...
  return (
    <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
        ...
        <div style={{ marginTop: "30px" }}>Employer's Firstname</div>
        ...
        <div style={{ height: "10px" }}></div>
        <div>Employer's Organization</div>
        <div style={{ height: "5px" }}></div>
        <input
          onChange={(e) => {
            let d = e.target.value;
        ...
        <input
          onClick={() => {
            if (check()) {
              ...
              axios
                .post("http://localhost:5000/users/employer/signup", data, {
                  headers: headers,
                })
                .then((res) => {
